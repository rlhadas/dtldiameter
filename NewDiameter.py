...
# Note species tree is assumed to be in vertex format, with root 'hTop'
...
def t():
    return calculate_ancestral_table(reformat_tree(DTLReconGraph.reconcile('le1',2,3,1)[0], 'hTop')[0])