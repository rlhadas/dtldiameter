...
def t(filename='le1', D=2, T=3, L=1):
    ...
    diameter = NewDiameter.new_diameter_algorithm(postorder_species_tree, postorder_gene_tree, gene_tree_root, median_reconciliation, dtl_recon_graph, False, False)
