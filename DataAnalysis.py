...
def findExtrema(csv_file):
    ...
    diameter_hist.set_xlabel("Diameter (normalized to gene node count)")
    diameter_hist.set_ylabel("Number of Results")
    ...
    diameter_time = ax[1]
    total_time = ax[2]
    diameter_time.scatter(gene_count_list, diameter_timings, c=gene_count_list)
    ...
    DP_time.scatter(gene_count_list, DP_timings, c=gene_count_list)
    ...
    total_time.scatter(gene_count_list, total_timings, c=gene_count_list)
